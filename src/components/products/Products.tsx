  ...
  const products: Product[] = [
    {
      ...
      description: 'Enterprise-grade financial management with real-time insights, automated compliance, and intelligent reporting for growing organizations.',
      features: [
    ...
    {
      name: 'IQ Retail ',
      description: 'Comprehensive point-of-sale and inventory ecosystem designed to optimize retail operations and enhance customer experiences.',
      features: [
    ...
    {
      name: 'Xact ERP',
      description: 'Full-spectrum enterprise resource planning for manufacturing and distribution, driving operational excellence and efficiency.',
      features: [
    ...
    {
      name: 'Sage 200',
      description: 'Trusted business management platform with proven scalability, empowering thousands of organizations worldwide to achieve their goals.',
      features: [
                ...
                <div className="flex items-start justify-between mb-6">
                  <div className="flex items-start gap-4">
                    <div 
                      ...
                      style={{
                        boxShadow: activeCard === idx ? `0 10px 30px -5px ${product.accentColor.primary}40` : ''
                      }}
                    >
                      {product.icon}
                    </div>
                    ...
                    <div>
                      ...
                      <div className="inline-flex items-center gap-2 text-sm font-semibold" style={{ color: product.accentColor.primary }}>
